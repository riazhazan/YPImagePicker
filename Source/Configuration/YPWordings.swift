...
public struct YPWordings {
    ...
    public var newPostTitle = ypLocalized("YPImagePickerLibrary")
    public var libraryTabTitle = ypLocalized("YPImagePickerLibrary")
    public var cameraTabTitle = ypLocalized("YPImagePickerPhoto")
}
